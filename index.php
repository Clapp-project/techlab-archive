...
$CONFIG = '{"lang":"en","error_reporting":true,"show_hidden":true,"hide_Cols":false,"calc_folder":false}';

/**
 * H3K | Tiny 技術部アーカイブ V2.4.1
...
//Application Title
define('APP_TITLE', '技術部アーカイブMarklll');
...
$auth_users = array(
    'admin' => '$2y$10$8pdHuitMFv9U54mfO2l5w.HWVuysAdmiLsZcOmtOOYaRPSG0Xc9Di', //admin@123
    'user' => '$2y$10$gbrBKYfZNEEX8H3OUtZKbOT5qAdtcieC0emj4WPtZ.3TGiLuAniDi' //KogoJHS
);
...
// Root path for 技術部アーカイブ
// use absolute path of directory i.e: '/var/www/folder' or $_SERVER['DOCUMENT_ROOT'].'/folder'
$root_path = $_SERVER['DOCUMENT_ROOT'];

// Root url for links in 技術部アーカイブ.Relative to $http_host. Variants: '', 'path/to/subfolder'
            ...
            <div class="card-body">
                <div class="row">
                    <div class="col-xs-12 col-sm-6">
                        <p><h3><a href="https://github.com/prasathmani/tinyfilemanager" target="_blank" class="app-v-title">技術部アーカイブ <?php echo VERSION; ?></a></h3></p>
...
<form action="" method="post" class="pt-3">
    ...
    <div class="row">
        ...
        <div class="col-3 d-none d-sm-block"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted"> 技術部アーカイブ <?php echo VERSION; ?></a></div>
        <?php else: ?>
            <div class="col-12"><a href="https://tinyfilemanager.github.io" target="_blank" class="float-right text-muted"> 技術部アーカイブ <?php echo VERSION; ?></a></div>
        <?php endif; ?>
    </div>
 ...
 class FM_Config
{
    ...
    function __construct()
    {
        ...
        if (strlen($CONFIG)) {
            ...
            $msg = '技術部アーカイブ<br>Error: Cannot load configuration';
            if (substr($fm_url, -1) == '/') {
                $fm_url = rtrim($fm_url, '/');
                $msg .= '<br>';
...
<head>
    ...
    <meta name="description" content="Web based 技術部アーカイブ in PHP, Manage your files efficiently and easily with  技術部アーカイブ">
...
function lng($txt) {
    ...
    // English Language
    $tr['en']['AppName']        = ' 技術部アーカイブ';      $tr['en']['AppTitle']           = '技術部アーカイブ';
    $tr['en']['Login']          = 'サインイン';                $tr['en']['Username']           = 'ユーザー名';
    $tr['en']['Password']       = 'パスワード';               $tr['en']['Logout']             = 'ログアウト';
    $tr['en']['Move']           = '移動';                   $tr['en']['Copy']               = 'コピー';
    $tr['en']['Save']           = '保存';                   $tr['en']['SelectAll']          = 'すべて選択';
    $tr['en']['UnSelectAll']    = '選択解除';           $tr['en']['File']               = 'ファイル';
    $tr['en']['Back']           = '戻る';                   $tr['en']['Size']               = 'サイズ';
    $tr['en']['Perms']          = 'Perms';                  $tr['en']['Modified']           = '更新';
    $tr['en']['Owner']          = '管理者';                  $tr['en']['Search']             = '検索';
    $tr['en']['NewItem']        = '新しいファイル';               $tr['en']['Folder']             = 'フォルダー';
    $tr['en']['Delete']         = '削除';                 $tr['en']['Rename']             = '名前の変更';
    $tr['en']['CopyTo']         = 'コピー先';                $tr['en']['DirectLink']         = 'リンク';
    $tr['en']['UploadingFiles'] = 'ファイルのアップロード';           $tr['en']['ChangePermissions']  = '権限の変更';
    $tr['en']['Copying']        = 'コピー';                $tr['en']['CreateNewItem']      = '新しいファイルの作成';
    $tr['en']['Name']           = '名前';                   $tr['en']['AdvancedEditor']     = 'アドバンスドエディタ';
    $tr['en']['RememberMe']     = 'ログインを記憶する';            $tr['en']['Actions']            = 'アクション';
    $tr['en']['Upload']         = 'アップロード';                 $tr['en']['Cancel']             = 'キャンセル';
    $tr['en']['InvertSelection']= 'Invert Selection';       $tr['en']['DestinationFolder']  = 'Destination Folder';
    $tr['en']['ItemType']       = 'ファイル名';              $tr['en']['ItemName']           = 'Item Name';
    $tr['en']['CreateNow']      = '作成';             $tr['en']['Download']           = 'ダウンロード';
    $tr['en']['Open']           = '開く';                   $tr['en']['UnZip']              = '解凍';
    $tr['en']['UnZipToFolder']  =   'フォルダに解凍';        $tr['en']['Edit']               = '編集';
    $tr['en']['NormalEditor']   = 'ノーマルエディタ';          $tr['en']['BackUp']             = 'バックアップ';
    $tr['en']['SourceFolder']   = 'Source Folder';          $tr['en']['Files']              = 'ファイル';
